...
export function CustomTooltip({
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-md border border-gray-300 bg-gray-0 shadow-2xl',
        className
      )}
    >
      <Text className="label mb-0.5 block bg-gray-100 p-2 px-2.5 text-center font-lexend text-xs font-semibold capitalize text-gray-600">
        {label}
      </Text>
